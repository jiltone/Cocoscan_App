      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _SettingTile(icon: Icons.timer_rounded, label: 'Timer', value: 'Off'),
            _SettingTile(icon: Icons.grid_on_rounded, label: 'Grid', value: 'Enabled'),
            _SettingTile(icon: Icons.hdr_on_rounded, label: 'HDR', value: 'Auto'),
            _SettingTile(icon: Icons.aspect_ratio_rounded, label: 'Aspect Ratio', value: '4:3'),
